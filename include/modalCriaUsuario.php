...
<div id="modalCriaChamado" class="modal">
        <div class="modal-content form-user">
            ...
            <form method="POST" class="form-chamado" action="../actions/criarUsuario.php">
                <div class="campo-id">
                <label for="cod-ops">Código do Operador:</label>
                <input type="text" id="cod-ops" name="cod-ops" size="8" required>
                </div>
                ...
                <div class="campo-email">
                    ...
                    <input type="email" id="email" size="80" required>
                </div>
                <div class="campo-senha">
                    <label for="senha">Senha:</label>
                    <input type="password" id="senha" max-length="12" size="8" required>
                </div>
